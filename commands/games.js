...
const {
    ...
    endGame,
    initGamesDB,
} = require("../meshtech/database/games");
...
const {
    ...
    endWcgGame,
    initWcgDB,
} = require("../meshtech/database/wcgGame");
...
const {
    ...
    endDiceGame,
    initDiceDB,
} = require("../meshtech/database/diceGame");
...
gmd({
    ...
    const { WcgDB } = require("../meshtech/database/wcgGame");
...
gmd({
    ...
    const rounds = parseInt(q) || 3;
    const { DiceDB } = require("../meshtech/database/diceGame");
