...
const {
  ...
  resetSetting,
  resetAllSettings,
} = require("../meshtech/database/settings");
const {
  getGroupSetting,
  setGroupSetting,
  ...
  getAllGroupSettings,
} = require("../meshtech/database/groupSettings");
const { getSudoNumbers, clearAllSudo } = require("../meshtech/database/sudo");
const {
  getAllUsersNotes,
  deleteNoteById,
  updateNoteById,
  deleteAllNotes,
  NotesDB,
} = require("../meshtech/database/notes");
...
gmd(
  ...
  async (from, MeshTech, conText) => {
    ...
    if (!value) {
      ...
      const { getBadWords } = require("../meshtech/database/groupSettings");
      ...
      if (action === "add") {
        ...
        for (let i = 0; i < chunks.length; i++) {
          ...
          msg += chunk
            ...
            .join("\n");
          await MeshTech.sendMessage(from, { text: msg });
        }
        await react("✅");
