    ...
    try {
        ...
        const splitSession = (value) => {
            ...
            return {
                ...
                payload: value.slice(separatorIndex + 1),
            };
        };
        ...
        if (!b64Check.startsWith('H4sI')) {
            throw new Error(
                "❌ Incomplete session ID. Use a complete MeshTech~ session generated by your own MESHTECH pairing service; third-party session servers are not supported."
            );
        }
