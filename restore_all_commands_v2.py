...
replacements = [
    ...
    # Cleanup apikey in query strings
    (r"apikey=\${MeshTechApiKey}&", ""),
    (r"&apikey=\${MeshTechApiKey}", ""),
    (r"\?apikey=\${MeshTechApiKey}", "?"),
    
    # Cleanup apikey in params objects
...
def restore_file(filepath):
    ...
    # Final cleanup for empty params objects if they occur
    content = re.sub(r"params:\s*{\s*}", "params: {}", content)
