...
replacements = [
    ...
    (r"https?://yts\.meshtechtech\.co\.ke", "${MeshTechApi}/api/s/youtube"),
    (r"https?://files\.meshtechtech\.co\.ke", "https://api.siputzx.my.id"),
    (r"https?://apiskeith\.top", "https://api.maher-zubair.tech"),
    ...
    (r"/api/download/spotifydlv2", "/api/d/spotifyv2"),
    (r"/api/download/gdrivedl", "/api/d/gdrive"),
    ...
    (r"&apikey=\${MeshTechApiKey}", ""),
    (r"\?apikey=\${MeshTechApiKey}", "?"),
    (r"apikey:\s*MeshTechApiKey,\s*", ""),
    (r",\s*apikey:\s*MeshTechApiKey", ""),
    (r"apikey:\s*MeshTechApiKey", ""),
]
...
def restore_file(filepath):
    ...
    content = content.replace("params: { verse: verse }", "params: { query: verse }")
    content = content.replace("params: { search: q.trim() }", "params: { query: q.trim() }")
    content = content.replace("params: { q: q }", "params: { query: q }")
